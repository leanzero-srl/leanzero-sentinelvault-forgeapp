...
export const CONTROLS = Object.freeze([
  ...
  { key: "signSealActions", scope: "global", group: "protection", kind: "toggle", optIn: true,
    label: "Sign seal actions with an authenticator code",
    text: "Releasing a seal, extending it, and approving, declining, giving or revoking edit access all ask for the current code from the authenticator app set up on My work. Without a signature set up, those actions are refused until it is.",
    default: POLICY_DEFAULTS.signSealActions },

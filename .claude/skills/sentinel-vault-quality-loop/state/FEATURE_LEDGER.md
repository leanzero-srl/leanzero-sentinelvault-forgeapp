...
|---|---------|---------|--------|----|----------|--------|------|------|----------|--------|
| 42 | Workflow state engine & state chip | Doc ribbon + realm console + backend | implemented (engine verified; chip+config pending) | 3 | 1 | 1 | 3 | 1 | 23.0 | aql/workflow-state-engine |

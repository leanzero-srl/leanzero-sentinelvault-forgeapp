...
| 52 | Configurable on-tamper target state (demote-to In Review) + editor/version in demote comment (A2) | Backend enforcement + settings editor | researched | — | — | — | — | — | 19.0 | Comala "updated → Review" parity; MEDIUM confidence — touches collectWorkflowEnforcementForPage, design-first + 3-lens trigger review |
| 53 | Per-state expiry + steward-editable review date in the dialog (A5) | Backend sweep + ribbon dialog + settings | researched | — | — | — | — | — | 18.0 | Comala due-date parity; MEDIUM confidence (sweep) |

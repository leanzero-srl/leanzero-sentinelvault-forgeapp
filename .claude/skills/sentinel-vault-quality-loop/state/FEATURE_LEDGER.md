...
| 50 | Approval evidence: symmetric decision reason + "Approval record" block (version at decision) (A4) | Ribbon approval dialog + panel | researched | — | — | — | — | — | 20.0 | Comala Document Approvals macro parity; HIGH confidence (data already pinned) |
| 51 | "View approved version" link on the workflow chip + stale copy (A6) | Doc ribbon | researched | — | — | — | — | — | 18.0 | one-line UI; HIGH confidence |

...
| 49 | Document Activity per page + space Activity report + CSV (Comala parity A1) | Doc ribbon dialog + inline panel + realm console tab | researched | — | — | — | — | — | 22.0 | 2026-09-05 Comala/Lockpoint parity pass (docs/PRODUCT-DEFINITION.md §5). Composes workflow-log-* + a new durable seal-log-* family; HIGH confidence; no new scopes |

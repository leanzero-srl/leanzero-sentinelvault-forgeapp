...
| 54 | Cross-space "My work" global page (approvals + seals + requests) (A7) | New confluence:globalPage | researched | — | — | — | — | — | 16.0 | resolvers exist; manifest module addition — verify whether a scope-free module is a minor bump |
| 55 | Per-state page restrictions as optional add-on to enforcement (A3) | Backend + settings | **implemented (it65) — `confluence:globalPage` my-work composing list-my-approvals / list-my-edit-requests / enumerate-operator-seals (all caller-scoped); Approve/Deny from the page; links via router.navigate; the module was a MINOR bump (6.97 → 6.100, install stayed Up-to-date); live: my-work-page.spec 1/1** | — | — | — | — | — | 14.0 | Comala add/set/remove-restrictions parity; LOW confidence until the v1 restrictions API is probed under Forge; likely new scope → major |

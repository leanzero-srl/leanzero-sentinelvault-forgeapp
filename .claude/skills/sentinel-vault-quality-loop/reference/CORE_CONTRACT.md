...
**S3. Trash of a sealed attachment is auto-restored (PUT status "current", version+1) with the seal kept; on restore failure OR permanent delete, seal state is cleaned and the owner notified.**
